...
const TestimonialCard = ({ testimonial }) => {
    return (
        <div className='md:p-5 border rounded-md bg-slate-50'>
            <div className='flex flex-col items-center justify-center text-center relative border rounded-md bg-white p-5 z-10'>
                <img src={testimonial.profile} alt={testimonial.name} className='w-20 h-20 absolute -top-6 md:-top-10 rounded-full border-8 border-slate-400 z-20' />
                ...
                <h4 className='text-sm font-semibold mt-2 fl'>{testimonial.comment}</h4>
